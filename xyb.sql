...
-- Records of xyb_role
-- ----------------------------
INSERT INTO `xyb_role` VALUES ('1', '0', '1', '1329633709', '1329633709', '0', '超级管理员', '拥有网站最高管理员权限！');
INSERT INTO `xyb_role` VALUES ('2', '0', '1', '1329633709', '1329633709', '0', '普通管理员', '权限由最高管理员分配！');
...
-- ----------------------------
DROP TABLE IF EXISTS `xyb_user_action`;
CREATE TABLE `xyb_user_action` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
